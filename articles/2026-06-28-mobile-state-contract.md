...
Experiment: /path/to/project-root/experiments/2026-06-28-mobile-state-contract
```
...
- Experiment: `/path/to/project-root/experiments/2026-06-28-mobile-state-contract/`
- Vibe prompt: `/path/to/project-root/experiments/2026-06-28-mobile-state-contract/prompt-vibe.txt`
- Fixed Task Packet: `/path/to/project-root/experiments/2026-06-28-mobile-state-contract/AI_TASK_PACKET_v0.5.md`
- Vibe audit log: `/path/to/project-root/experiments/2026-06-28-mobile-state-contract/logs/vibe-audit.log`
- Fixed audit log: `/path/to/project-root/experiments/2026-06-28-mobile-state-contract/logs/fixed-audit.log`
- Vibe GIF: `/path/to/project-root/assets/2026-06-28-mobile-state-vibe.gif`
- Fixed GIF: `/path/to/project-root/assets/2026-06-28-mobile-state-fixed.gif`
- Standard updated: `/path/to/project-root/standards/aidd-spec-ai-task-packet-standard-v0.1.md`
