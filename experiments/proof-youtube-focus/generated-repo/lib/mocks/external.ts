...
export const mockServiceUrls = {
  api: process.env.STUDYSTREAM_MOCK_API_URL ?? "http://127.0.0.1:4010",
  media: process.env.STUDYSTREAM_MOCK_MEDIA_URL ?? "http://127.0.0.1:4020",
  auth: process.env.STUDYSTREAM_MOCK_AUTH_URL ?? "http://127.0.0.1:4030",
  billing: process.env.STUDYSTREAM_MOCK_BILLING_URL ?? "http://127.0.0.1:4040"
};

export function shouldUseExternalMockServices(): boolean {
  return process.env.STUDYSTREAM_USE_EXTERNAL_MOCKS === "1";
}
