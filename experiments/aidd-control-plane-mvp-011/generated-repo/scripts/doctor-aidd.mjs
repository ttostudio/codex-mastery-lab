...
const requiredFiles = [
  ...
  "scripts/capture-mvp011.mjs"
];
const requiredScripts = ["lint", "typecheck", "test", "build", "test:e2e", "doctor:aidd", "capture:mvp011"];
const requiredCopy = [
  "何を作りたいですか？",
  "誰のどんな問題を解決しますか？",
  "作らないものを決める",
...
if (existsSync(packagePath)) {
  ...
  if (packageJson.name !== "aidd-control-plane-mvp-011") fail(`unexpected package name: ${packageJson.name}`);
